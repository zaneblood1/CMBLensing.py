...
#conda init #NOTE this line may have been redundant
...
python3 /resnick/groups/wugroup/zblood/cmb_lensing/performance_testing/python_performance_test.py --map_size $1 --seed $2 --trial $3 --pol $4