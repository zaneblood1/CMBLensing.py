...
class DataSetT(DataSet):
    ...
    scalar_field_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
    tensor_field_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
    phi_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
    unscaled_phi_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
...
class DataSetEB(DataSet):
    ...
    scalar_field_covariance: DiagonalEB = flax.struct.field(default_factory = lambda: DiagonalEB())
    tensor_field_covariance: DiagonalEB = flax.struct.field(default_factory = lambda: DiagonalEB())
    phi_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
    unscaled_phi_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
...
class DataSetTEB(DataSet):
    ...
    scalar_field_covariance: BlockTEB = flax.struct.field(default_factory = lambda: BlockTEB())
    tensor_field_covariance: BlockTEB = flax.struct.field(default_factory = lambda: BlockTEB())
    phi_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
    unscaled_phi_covariance: DiagonalScalar = flax.struct.field(default_factory = lambda: DiagonalScalar())
