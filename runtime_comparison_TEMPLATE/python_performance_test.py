import os
import shutil
#TODO you must replace the place holder file paths below
os.environ["PYTHON_JULIAPKG_PROJECT"] = "<ABSOLUTE_PATH_TO>/CMBLensing.jl"
...
os.makedirs(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/uncached_times", exist_ok = True)
np.savetxt(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/uncached_times/uncached_time_{args.trial}.txt", \
           np.array([total_time]))
...
os.makedirs(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/cached_times", exist_ok = True)
np.savetxt(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/cached_times/cached_time_{args.trial}.txt", \
           np.array([total_time]))

#store the learned / estimated f and phi from python to compare with what julia found
os.makedirs(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb", exist_ok = True)
os.makedirs(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/lensing_potential", exist_ok = True)

#cmb fields:
#branching logic on saving the fields based on polarization equals I, P, or IP
if args.pol == "I":
    #Save the python prediction
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/t_field_python_predict_{args.trial}.npz", field_python_predict.scalar_matrix)
    #Also save the simulation ground truth
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/t_field_julia_simulation_{args.trial}.npz", jnp.array(jl.t_field_I))
elif args.pol == "P":
    #Save the python prediction
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/e_field_python_predict_{args.trial}.npz", field_python_predict.polar_matrix_1)
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/b_field_python_predict_{args.trial}.npz", field_python_predict.polar_matrix_2)
    #Also save the simulation ground truth
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/e_field_julia_simulation_{args.trial}.npz", jnp.array(jl.e_field_P))
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/b_field_julia_simulation_{args.trial}.npz", jnp.array(jl.b_field_P))
else:
    #Save the python prediction
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/t_field_python_predict_{args.trial}.npz", field_python_predict.scalar_matrix)
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/e_field_python_predict_{args.trial}.npz", field_python_predict.polar_matrix_1)
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/b_field_python_predict_{args.trial}.npz", field_python_predict.polar_matrix_2)
    #Also save the simulation ground truth
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/t_field_julia_simulation_{args.trial}.npz", jnp.array(jl.t_field_IP))
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/e_field_julia_simulation_{args.trial}.npz", jnp.array(jl.e_field_IP))
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/cmb/b_field_julia_simulation_{args.trial}.npz", jnp.array(jl.b_field_IP))

#Lensing potential fields:
#Save the python prediction
np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/lensing_potential/phi_python_predict_{args.trial}.npz", phi_python_predict.scalar_matrix)
#Also save the simulation ground truth
if args.pol == "I":
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/lensing_potential/phi_julia_simulation_{args.trial}.npz", jnp.array(jl.phi_I))
elif args.pol == "P":
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/lensing_potential/phi_julia_simulation_{args.trial}.npz", jnp.array(jl.phi_P))
else:
    np.savez(f"<ABSOLUTE_PATH_TO>/cmb_lensing/runtime_comparison/performance_results/python_results/map_size_{args.map_size}_polarity_{args.pol}_seed_{args.seed}/learned_fields/lensing_potential/phi_julia_simulation_{args.trial}.npz", jnp.array(jl.phi_IP))